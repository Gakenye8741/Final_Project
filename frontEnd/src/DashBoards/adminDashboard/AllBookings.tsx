...
//     return (
//       (searchTerm ? b.bookingId.toString().includes(searchTerm) || b.nationalId.toString().includes(searchTerm) : true) &&
//       (statusFilter ? b.bookingStatus === statusFilter : true) &&
//       (eventFilter ? b.eventId.toString() === eventFilter : true)
//     );
//   });
...
//       input: "select",
//       inputOptions: bookingStatusEnum.reduce((acc, status) => ({ ...acc, [status]: status }), {} as Record<string, string>),
...
//               className="px-4 py-2 w-full sm:w-36 rounded-md bg-slate-700 text-white placeholder-white/70"
//               value={eventFilter}
...
//                     <td className="px-4 py-2">{b.eventId}</td>
...
//                         className="px-3 py-1 bg-gray-500 hover:bg-gray-600 rounded text-white text-xs"
//                       >
//                         Delete
//                       </button>
//                     </td>
